...
interface AdhocRouteGeneratorProps {
...
export default function AdhocRouteGenerator({ 
  onRouteGenerated, 
  className = '' 
}: AdhocRouteGeneratorProps) {
  ...
  const [generatedRoute, setGeneratedRoute] = useState<AdhocRoute | null>(null);
  ...
  return (
    <Card className={className}>
      ...
      <CardContent className="space-y-4">
        ...
        {/* Custom Route Name */}
        <div className="space-y-2">
          <Label>Custom Route Name (Optional)</Label>
          <Input
            value={customName}
