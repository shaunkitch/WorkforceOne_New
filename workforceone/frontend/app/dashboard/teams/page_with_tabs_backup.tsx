...
function InviteMembersModal({ isOpen, onClose, onSuccess }: InviteMembersModalProps) {
  const [invitations, setInvitations] = useState([
    { email: '', role: 'member', department: '' }
  ])
  ...
  const addInvitation = () => {
    setInvitations([...invitations, { email: '', role: 'member', department: '' }])
  }
  ...
  const sendInvitations = async () => {
    ...
    try {
      ...
      const invitationRecords = validInvitations.map(inv => ({
      ...
      alert('Successfully sent ' + validInvitations.length + ' invitation(s)!')
      onSuccess()
    } catch (error) {
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <Label className="text-base font-medium">Invitations</Label>
                <Button
                  type="button"
                  variant="outline"
                  size="sm"
            ...
            <div className="border-t pt-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>• You can resend or cancel invitations from the team management page</li>
                </ul>
              </div>
              ...
              <div className="flex justify-end space-x-3">
                ...
                <Button
                  ...
                  disabled={loading || !invitations.some(inv => inv.email.trim())}
